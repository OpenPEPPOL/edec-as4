...
The message partition channel feature as defined in link:#ref_ebMS3CORE[[ebMS3CORE\]] is not needed for the message exchanges between the Access Points in the PEPPOL eDelivery Network. Therefore the default MPC is used, i.e. *PMode[1].BusinessInfo.MPC* MUST be set to: +
